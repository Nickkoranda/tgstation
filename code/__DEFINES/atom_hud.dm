...
#define DATA_HUD_MEDICAL_MENTAL 3
#define DATA_HUD_MEDICAL_BASIC 4
#define DATA_HUD_MEDICAL_ADVANCED 5
#define DATA_HUD_DIAGNOSTIC_BASIC 6
#define DATA_HUD_DIAGNOSTIC_ADVANCED 7
